...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(PROJECT_PATH, 'dicom_review.db')
    }
}
...
TEMPLATE_CONTEXT_PROCESSORS += (
    ...
    'dicom_review.context_processors.static',
)
...
EMAIL_SUBJECT_PREFIX = '[dicom_review] '
...
CSRF_COOKIE_NAME = 'dicom_review_csrftoken'

# SESSION_COOKIE_AGE = 60 * 20
SESSION_ENGINE = 'django.contrib.sessions.backends.cache'
SESSION_COOKIE_NAME = 'dicom_review_sessionid'
